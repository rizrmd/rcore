...
export default defineAPI({
  name: "book",
  url: "/book/:page",
  async handler(): Promise<BookResponse> {
    const req = this.req!;
    ...
    const seo_data = {
      slug: `/book${page > 1 ? `/${page}` : ``}`,
      page: page,
      meta_title: `Temukan Ribuan Judul Buku Terbaik Indonesia | Esensi Online`,
      meta_description: `Lihat semua koleksi buku terbaik Indonesia. Temukan bacaan favorit Anda dan beli buku berkualitas dengan harga terjangkau hanya di sini.`,
      image: ``,
      headings: `Temukan Ribuan Buku Terbaik Indonesia | Esensi Online`,
      paragraph: `Lihat semua koleksi buku terbaik Indonesia. Temukan bacaan favorit Anda dan beli buku berkualitas dengan harga terjangkau hanya di Esensi Online.`,
      is_product: false,
    };
