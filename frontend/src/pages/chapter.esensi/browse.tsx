...
import { FilterIcon, BookOpenIcon } from "lucide-react";
            ...
            <div className="flex items-center gap-4 mx-auto">
              ...
              <div className="text-white">
                <h1 className="text-2xl font-bold mb-2">
                  Jelajahi Koleksi Bacaan Terlengkap
                </h1>
                <p className="text-white/90 text-base">
                  Temukan bacaan favorit dari berbagai genre dan kategori. Gunakan
                  filter untuk hasil yang lebih spesifik
                </p>
              </div>
            </div>
          </div>
