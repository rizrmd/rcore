...
export default () => {
  return (
    <EsensiChapterLayout enableHeader={false} enableFooter={false} enableProfileDrawer={false}>
      <div className="w-full min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-(--esensi-color) to-slate-800">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen">
          <div className="text-center space-y-8 px-4">
            ...
            <div className="space-y-4">
              <EsensiChapterLogo className="h-12 w-auto mb-4 mx-auto" style={{"--esensi-color":"#fff", "--esensi-color-alt":"#fff"} as React.CSSProperties} />
              <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold text-white tracking-wider">
                ...
                <br className="lg:hidden"/><span className="mx-4 hidden lg:inline-block"></span>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Something amazing is in the works. Stay tuned for an incredible
              reading experience.
            </p>
